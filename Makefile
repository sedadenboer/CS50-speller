speller: dictionary.c dictionary.h speller.c Makefile
	...
	clang -ggdb3 -O0 -Qunused-arguments -std=c11 -Wall -Werror -Wextra -Wno-sign-compare -Wno-unused-parameter -Wno-unused-variable -Wshadow -lm -o speller speller.o dictionary.o
